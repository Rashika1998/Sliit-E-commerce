...
public class RequesterRegistrationActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        sellerLoginBegin.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent = new Intent(RequesterRegistrationActivity.this , RequesterLoginActivity.class);
                            ...
                            if (task.isSuccessful())
                            {
                                ...
                                rootRef.child("sellers").child(sid).updateChildren(sellerMap)
                                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                                            ...
                                            {
                                                loadingBar.dismiss();
                                                Toast.makeText(RequesterRegistrationActivity.this, "You are registered successfully...", Toast.LENGTH_SHORT).show();

                                                Intent intent = new Intent(RequesterRegistrationActivity.this , RequesterHomeActivity.class);
