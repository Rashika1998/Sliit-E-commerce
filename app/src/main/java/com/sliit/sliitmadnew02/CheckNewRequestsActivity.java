...
import com.sliit.sliitmadnew02.ViewHolder.RequestsViewHolder;
...
public class CheckNewRequestsActivity extends AppCompatActivity
{
    ...
    protected void onStart()
    {
        ...
        FirebaseRecyclerOptions<Products> options =
                ...
                .setQuery(unverifiedProductsRef.orderByChild("productStatus").equalTo("Not approved this product.") , Products.class)
                .build();
